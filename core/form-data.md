...
**⚠ Adding support for `application/x-www-form-urlencoded` makes your API vulnerable to \[CSRF attacks\]\(**[https://www.owasp.org/index.php/Cross-Site\_Request\_Forgery\_\(CSRF](https://www.owasp.org/index.php/Cross-Site_Request_Forgery_%28CSRF)**\)\). Be sure to enable proper countermeasures** [**such as DunglasAngularCsrfBundle**](https://github.com/dunglas/DunglasAngularCsrfBundle)**.**
